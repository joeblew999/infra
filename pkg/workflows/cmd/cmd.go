...
// GetRootWorkflowCmds returns commands that should be at root level
func GetRootWorkflowCmds() []*cobra.Command {
	return []*cobra.Command{
		deployCmd,
		statusCmd,
		initCmd,
...
// AddFlyCommands adds fly commands to a parent command
func AddFlyCommands(parent *cobra.Command) {
	fly.AddCommands(parent)
}
