...
Examples:
  infra cli gozero api create myservice --mcp --output ./api/myservice
  infra cli gozero api generate myservice.api --swagger --output .
  infra cli gozero quickstart mono --output ./my-project`,
}
