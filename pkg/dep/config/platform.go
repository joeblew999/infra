// Package config provides cross-platform binary naming utilities and configuration
// for the dep package. This includes platform-specific file naming and supported
...
// SupportedPlatforms returns the list of platforms we support for binary distribution
func SupportedPlatforms() []struct{ OS, Arch string } {
